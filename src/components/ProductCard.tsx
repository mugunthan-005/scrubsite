  ...
  return (
    ...
    >
      ...
      <div className="mt-3.5 px-1">
        ...
        <h3 className="mt-1 font-semibold text-white leading-snug group-hover:text-teal-300 transition-colors">
          {product.name}
        </h3>
        {/* Color swatches */}
        <div className="mt-2 flex items-center gap-1.5">
          {product.colors.slice(0, 5).map((c) => (
            <span
              key={c.name}
              title={c.name}
              className="h-4 w-4 rounded-full ring-1 ring-white/30 ring-offset-1 ring-offset-slate-900"
